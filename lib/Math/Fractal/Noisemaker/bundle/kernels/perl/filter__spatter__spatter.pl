...
my $run_pixel = sub {
    ...
    my $U = $ctx->uniforms;
    my $g = {};
    my ($pcg3__uvec3, $pcg__uint, $hashf__uint, $gridVal__ivec2_uint, $cubic__float_float_float_float_float, $bicubicExpGrid__vec2_uint, $bilinearExpGrid__vec2_uint, $cosineExpGrid__vec2_uint, $expFbm6Bicubic__vec2_vec2_uint, $expFbm4Bilinear__vec2_vec2_uint, $expRidgedFbm3Cosine__vec2_vec2_uint, $main__void);
    my $_retc;
    ...
    $pcg__uint = sub {
        my ($v) = @_;
        return $rt->swizzle($pcg3__uvec3->($rt->construct(3, $v, $rt->i(0), $rt->i(0), 'uint')), 'x');
    };
    $hashf__uint = sub {
        my ($h) = @_;
        return $rt->binary('/', $rt->construct(1, $rt->swizzle($pcg3__uvec3->($rt->construct(3, $h, $rt->i(0), $rt->i(0), 'uint')), 'x')), $rt->construct(1, $rt->i(4294967295)), 1, 'float');
    };
    $gridVal__ivec2_uint = sub {
        my ($p, $sd) = @_;
        $p = $rt->copy($p, 'int');
        my ($h);
        $h = $pcg3__uvec3->($rt->construct(3, $rt->construct(1, $rt->binary('+', $rt->swizzle($p, 'x'), $rt->i(32768), 1, 'int'), 'uint'), $rt->construct(1, $rt->binary('+', $rt->swizzle($p, 'y'), $rt->i(32768), 1, 'int'), 'uint'), $sd, 'uint'));
        return $rt->binary('/', $rt->construct(1, $rt->swizzle($h, 'x')), $rt->construct(1, $rt->i(4294967295)), 1, 'float');
    };
    $cubic__float_float_float_float_float = sub {
        my ($a, $b, $c, $d, $t) = @_;
        my ($t2, $t3);
        $t2 = $rt->binary('*', $t, $t, 1, 'float');
        $t3 = $rt->binary('*', $t2, $t, 1, 'float');
        return $rt->binary('*', $rt->f(0.5), $rt->binary('+', $rt->binary('+', $rt->binary('+', $rt->binary('*', $rt->f(2), $b, 1, 'float'), $rt->binary('*', $rt->binary('+', $rt->unary('-', $a), $c, 1, 'float'), $t, 1, 'float'), 1, 'float'), $rt->binary('*', $rt->binary('-', $rt->binary('+', $rt->binary('-', $rt->binary('*', $rt->f(2), $a, 1, 'float'), $rt->binary('*', $rt->f(5), $b, 1, 'float'), 1, 'float'), $rt->binary('*', $rt->f(4), $c, 1, 'float'), 1, 'float'), $d, 1, 'float'), $t2, 1, 'float'), 1, 'float'), $rt->binary('*', $rt->binary('+', $rt->binary('-', $rt->binary('+', $rt->unary('-', $a), $rt->binary('*', $rt->f(3), $b, 1, 'float'), 1, 'float'), $rt->binary('*', $rt->f(3), $c, 1, 'float'), 1, 'float'), $d, 1, 'float'), $t3, 1, 'float'), 1, 'float'), 1, 'float');
    };
    $bicubicExpGrid__vec2_uint = sub {
        my ($pos, $sd) = @_;
        $pos = $rt->copy($pos, 'float');
        my ($c, $f, $r0, $r1, $r2, $r3);
        $c = $rt->construct(2, $rt->component_wise('floor', $pos), 'int');
        $f = $rt->component_wise('fract', $pos);
        $r0 = $cubic__float_float_float_float_float->($rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->unary('-', $rt->i(1)), $rt->unary('-', $rt->i(1)), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(0), $rt->unary('-', $rt->i(1)), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(1), $rt->unary('-', $rt->i(1)), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(2), $rt->unary('-', $rt->i(1)), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->swizzle($f, 'x'));
        $r1 = $cubic__float_float_float_float_float->($rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->unary('-', $rt->i(1)), $rt->i(0), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(0), $rt->i(0), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(1), $rt->i(0), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(2), $rt->i(0), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->swizzle($f, 'x'));
        $r2 = $cubic__float_float_float_float_float->($rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->unary('-', $rt->i(1)), $rt->i(1), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(0), $rt->i(1), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(1), $rt->i(1), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(2), $rt->i(1), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->swizzle($f, 'x'));
        $r3 = $cubic__float_float_float_float_float->($rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->unary('-', $rt->i(1)), $rt->i(2), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(0), $rt->i(2), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(1), $rt->i(2), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(2), $rt->i(2), 'int'), 2, 'int'), $sd), $rt->f(4)), $rt->swizzle($f, 'x'));
        return $rt->component_wise('clamp', $cubic__float_float_float_float_float->($r0, $r1, $r2, $r3, $rt->swizzle($f, 'y')), $rt->f(0), $rt->f(1));
    };
    $bilinearExpGrid__vec2_uint = sub {
        my ($pos, $sd) = @_;
        $pos = $rt->copy($pos, 'float');
        my ($c, $f, $v00, $v01, $v10, $v11);
        $c = $rt->construct(2, $rt->component_wise('floor', $pos), 'int');
        $f = $rt->component_wise('fract', $pos);
        ...
        $v11 = $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(1), $rt->i(1), 'int'), 2, 'int'), $sd), $rt->f(4));
    ...
    $cosineExpGrid__vec2_uint = sub {
        ...
        $v01 = $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(0), $rt->i(1), 'int'), 2, 'int'), $sd), $rt->f(4));
        $v11 = $rt->component_wise('pow', $gridVal__ivec2_uint->($rt->binary('+', $c, $rt->construct(2, $rt->i(1), $rt->i(1), 'int'), 2, 'int'), $sd), $rt->f(4));
        return $rt->component_wise('mix', $rt->component_wise('mix', $v00, $v10, $rt->swizzle($t, 'x')), $rt->component_wise('mix', $v01, $v11, $rt->swizzle($t, 'x')), $rt->swizzle($t, 'y'));
    };
    $expFbm6Bicubic__vec2_vec2_uint = sub {
        my ($uv, $freq, $sd) = @_;
        $uv = $rt->copy($uv, 'float');
    ...
    $main__void = sub {
        ...
        $speckFreq = $rt->component_wise('mix', $rt->f(150), $rt->f(200), $hashf__uint->($pcg__uint->($rt->binary('+', $s, $rt->i(90), 1, 'uint'))));

...
my $run_pixel = sub {
    ...
    $main__void = sub {
        my ($color, $globalCoord, $ref, $s, $st, $uv, $xFreq, $xRef, $yFreq, $yRef);
        ...
        $yFreq = $rt->f(1);
        if ($rt->binary('==', $_u_NOISE_TYPE, $rt->i(10))) {
            $xFreq = $map__float_float_float_float_float->($_u_noiseScale, $rt->f(1), $rt->f(100), $rt->f(1), $rt->f(0.25));
            $yFreq = $rt->binary('*', $xFreq, $rt->f(1.5), 1, 'float');
        } else {
            if ($rt->binary('==', $_u_NOISE_TYPE, $rt->i(4))) {
                $xFreq = $map__float_float_float_float_float->($_u_noiseScale, $rt->f(1), $rt->f(100), $rt->f(1.5), $rt->f(1));
                $yFreq = $rt->binary('*', $xFreq, $rt->f(1.5), 1, 'float');
            } else {
                if ($_u_wrap) {
                    $xFreq = $rt->component_wise('floor', $map__float_float_float_float_float->($_u_noiseScale, $rt->f(1), $rt->f(100), $rt->f(3), $rt->f(2)));
                    $yFreq = $xFreq;
                } else {
                    $xFreq = $map__float_float_float_float_float->($_u_noiseScale, $rt->f(1), $rt->f(100), $rt->f(1.5), $rt->f(1));
                    $yFreq = $rt->binary('*', $xFreq, $rt->f(1.5), 1, 'float');
        ...
        $xRef = $value__vec2_float_float_float->($st, $xFreq, $yFreq, $rt->binary('+', $rt->unary('+', $rt->f(20)), $s, 1, 'float'));
        $yRef = $value__vec2_float_float_float->($st, $xFreq, $yFreq, $rt->binary('+', $rt->unary('+', $rt->f(10)), $s, 1, 'float'));
        $ref = $map__float_float_float_float_float->($_u_refractAmt, $rt->f(0), $rt->f(100), $rt->f(0), $rt->f(2.5));
        ...
        if ($rt->binary('==', $_u_COLOR_MODE, $rt->i(0))) {
            ...
            @{$color} = map { $rt->f32($_) } @{($rt->construct(4, $value__vec2_float_float_float->($uv, $xFreq, $yFreq, $s), $value__vec2_float_float_float->($uv, $xFreq, $yFreq, $rt->binary('+', $rt->f(10), $s, 1, 'float')), $value__vec2_float_float_float->($uv, $xFreq, $yFreq, $rt->binary('+', $rt->f(20), $s, 1, 'float')), $rt->f(1)))};
        }
        if ($rt->binary('==', $_u_COLOR_MODE, $rt->i(0))) {
            if ($_u_ridges) {
                @{$color} = map { $rt->f32($_) } @{($rt->binary('-', $rt->f(1), $rt->component_wise('abs', $rt->binary('-', $rt->binary('*', $color, $rt->f(2), 4, 'float'), $rt->f(1), 4, 'float')), 4, 'float'))};
            }
        } else {

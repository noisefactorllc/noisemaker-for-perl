...
my $run_pixel = sub {
    ...
    my $_u_REFRACT_MODE = exists $U->{'REFRACT_MODE'} ? $U->{'REFRACT_MODE'} : 0;
    ...
    my $_u_xScale = exists $U->{'xScale'} ? $U->{'xScale'} : $rt->f(0.0);
    my $_u_yScale = exists $U->{'yScale'} ? $U->{'yScale'} : $rt->f(0.0);
    ...
    $generate_octave__vec2_vec2_float_float_float = sub {
        my ($st, $freq, $s, $blend, $octave) = @_;
        $st = $rt->copy($st, 'float');
        $freq = $rt->copy($freq, 'float');
        my ($layer);
        $layer = $rt->construct(3, $value__vec2_vec2_float_float->($st, $freq, $rt->binary('+', $rt->construct(1, $_u_seed), $rt->binary('*', $rt->f(10), $octave, 1, 'float'), 1, 'float'), $blend), $value__vec2_vec2_float_float->($st, $freq, $rt->binary('+', $rt->construct(1, $_u_seed), $rt->binary('*', $rt->f(20), $octave, 1, 'float'), 1, 'float'), $blend), $value__vec2_vec2_float_float->($st, $freq, $rt->binary('+', $rt->construct(1, $_u_seed), $rt->binary('*', $rt->f(30), $octave, 1, 'float'), 1, 'float'), $blend));
    ...
    $multires__vec2_vec2_int_float_float = sub {
        my ($st, $freq, $octaves, $s, $blend) = @_;
        $st = $rt->copy($st, 'float');
        $freq = $rt->copy($freq, 'float');
        my ($_for2_first, $baseFreq, $color, $d, $i, $layer, $multiplicand, $multiplier, $nominalBase, $nominalBase10, $nominalBase11, $nominalBaseV, $nominalFreq, $ref, $xOff, $xRef, $xRefractFreq, $yOff, $yRef, $yRefractFreq);
        ...
        if ($rt->binary('==', $_u_NOISE_TYPE, $rt->i(11))) {
            $nominalBase11 = $map__float_float_float_float_float->($rt->f(75), $rt->f(1), $rt->f(100), $rt->f(40), $rt->f(1));
            $nominalFreq = $rt->construct(2, $nominalBase11);
        } else {
            if ($rt->binary('==', $_u_NOISE_TYPE, $rt->i(10))) {
                $nominalBase10 = $map__float_float_float_float_float->($rt->f(75), $rt->f(1), $rt->f(100), $rt->f(6), $rt->f(0.5));
                $nominalFreq = $rt->construct(2, $nominalBase10);
            } else {
                $nominalBaseV = $map__float_float_float_float_float->($rt->f(75), $rt->f(1), $rt->f(100), $rt->f(20), $rt->f(3));
        ...
        if ($rt->binary('==', $_u_COLOR_MODE, $rt->i(0))) {
            ...
            if ($rt->binary('==', $_u_COLOR_MODE, $rt->i(1))) {
                @{$color} = map { $rt->f32($_) } @{($srgbToLinear__vec3->($color))};
            } else {
                if ($rt->binary('==', $_u_COLOR_MODE, $rt->i(2))) {
                    ...
                    if ($rt->binary('==', $_u_COLOR_MODE, $rt->i(3))) {
                        ...
                        if ($rt->binary('==', $_u_COLOR_MODE, $rt->i(4))) {
                            ...
                            @{$color} = map { $rt->f32($_) } @{($pal__float->($d))};
                        } else {
        ...
        if ((((($rt->binary('!=', $_u_COLOR_MODE, $rt->i(4))) && ($rt->binary('!=', $_u_COLOR_MODE, $rt->i(6))) ? 1 : 0)) && ($rt->binary('!=', $_u_COLOR_MODE, $rt->i(0))) ? 1 : 0)) {
            @{$color} = map { $rt->f32($_) } @{($rgb2hsv__vec3->($color))};
            $color = $rt->assign_swizzle($color, 'r', $rt->binary('+', $rt->swizzle($color, 'r'), $rt->binary('-', $rt->f(1), $rt->binary('/', $_u_hueRotation, $rt->f(360), 1, 'float'), 1, 'float'), 1, 'float'));
            $color = $rt->assign_swizzle($color, 'r', $rt->component_wise('fract', $rt->swizzle($color, 'r')));
            if ((((($rt->binary('==', $_u_COLOR_MODE, $rt->i(1))) || ($rt->binary('==', $_u_COLOR_MODE, $rt->i(2))) ? 1 : 0)) || ($rt->binary('==', $_u_COLOR_MODE, $rt->i(3))) ? 1 : 0)) {
                if ($_u_ridges) {
                    $color = $rt->assign_swizzle($color, 'b', $rt->binary('-', $rt->f(1), $rt->component_wise('abs', $rt->binary('-', $rt->binary('*', $rt->swizzle($color, 'b'), $rt->f(2), 1, 'float'), $rt->f(1), 1, 'float')), 1, 'float'));
                }
            }
    ...
    $main__void = sub {
        ...
        if ($rt->binary('==', $_u_NOISE_TYPE, $rt->i(11))) {
            $freq = $rt->assign_swizzle($freq, 'x', $map__float_float_float_float_float->($_u_xScale, $rt->f(1), $rt->f(100), $rt->f(40), $rt->f(1)));
            $freq = $rt->assign_swizzle($freq, 'y', $map__float_float_float_float_float->($_u_yScale, $rt->f(1), $rt->f(100), $rt->f(40), $rt->f(1)));
            @{$lf} = map { $rt->f32($_) } @{($rt->construct(2, $map__float_float_float_float_float->($_u_loopScale, $rt->f(1), $rt->f(100), $rt->f(10), $rt->f(1))))};
        } else {
            if ($rt->binary('==', $_u_NOISE_TYPE, $rt->i(10))) {
                $freq = $rt->assign_swizzle($freq, 'x', $map__float_float_float_float_float->($_u_xScale, $rt->f(1), $rt->f(100), $rt->f(6), $rt->f(0.5)));
                $freq = $rt->assign_swizzle($freq, 'y', $map__float_float_float_float_float->($_u_yScale, $rt->f(1), $rt->f(100), $rt->f(6), $rt->f(0.5)));
                @{$lf} = map { $rt->f32($_) } @{($rt->construct(2, $map__float_float_float_float_float->($_u_loopScale, $rt->f(1), $rt->f(100), $rt->f(6), $rt->f(0.5))))};
            } else {
                $freq = $rt->assign_swizzle($freq, 'x', $map__float_float_float_float_float->($_u_xScale, $rt->f(1), $rt->f(100), $rt->f(20), $rt->f(3)));
                $freq = $rt->assign_swizzle($freq, 'y', $map__float_float_float_float_float->($_u_yScale, $rt->f(1), $rt->f(100), $rt->f(20), $rt->f(3)));
        ...
        if ($rt->binary('==', $_u_LOOP_OFFSET, $rt->i(300))) {
            $baseLoop = $rt->f(0.0);
            if ($rt->binary('==', $_u_NOISE_TYPE, $rt->i(11))) {
                $baseLoop = $map__float_float_float_float_float->($rt->f(75), $rt->f(1), $rt->f(100), $rt->f(40), $rt->f(1));
            } else {
                if ($rt->binary('==', $_u_NOISE_TYPE, $rt->i(10))) {
                    $baseLoop = $map__float_float_float_float_float->($rt->f(75), $rt->f(1), $rt->f(100), $rt->f(6), $rt->f(0.5));
                } else {
                    $baseLoop = $map__float_float_float_float_float->($rt->f(75), $rt->f(1), $rt->f(100), $rt->f(20), $rt->f(3));
                }
            }
